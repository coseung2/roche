...
**Foundation / Milestone 0.5**

목표는 UI framework 선택 전에 domain / runtime boundary를 안정시키고, 다음 단계인 Performance PoC와 Herdr 실연동을 시작할 수 있는 최소 골격을 만드는 것입니다.
...
- [ ] 100,000 messages virtualized list
- [ ] 100,000 tool events
- [ ] 1,000 sessions sidebar
- [ ] 50MB terminal log paging / ring buffer
- [ ] streaming append 부하 테스트
...
성능 PoC 이후에는 별도의 benchmark gate를 추가합니다.
